...
class TrajectoryPlanner:
    ...
    def plan_with_reasoning(self) -> bool:
        ...
        if self.scene_data.obstacle_data:
            ...
            needs_reasoning = needs_reasoning or self.scene_data.nearest_obstacle.relative_distance <= 20.0
    ...
    def _follow_route(
        ...
        if self.route_follow_ticks > 25:
            ...
            completion_reason = completion_reason or "Maintained route without for 1s"
        else:
    ...
    def _get_target_speed(
        ...
        if self.scene_data.nearest_obstacle:
            ...
            target_speed_obstacle = self.idm.compute_target_speed_idm(
                desired_speed=target_speed_initial,
            ...
            print(f'Obstacle ID: {self.scene_data.nearest_obstacle.id}, IDM Speed: {target_speed_obstacle}\n')
            target_speeds.append(target_speed_obstacle)
